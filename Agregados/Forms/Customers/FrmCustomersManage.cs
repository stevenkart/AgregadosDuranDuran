                        ...
                        try
                        {
                            ...
                            else
                            {
                                ...
                                if (DB.SaveChanges() > 0)
                                {
                                    CheckChange();
                                    limpiarBusqueda();
                                    MessageBox.Show("Vehículo Eliminado Correctamente!", "Registro de Clientes", MessageBoxButtons.OK);
                                    cliente = null;
                                }
                                else
                                {
                                    MessageBox.Show("Vehículo No fue Eliminado, por favor valide", "Error Registro de Clientes", MessageBoxButtons.OK);
                                    cliente = null;
                                }
                            }
                        }
